...
export default class ProblemManager extends Component {
  constructor(props) {
    super(props);
  ...
  fetchNewData = async () => {
    ...
    let problems = await Controller.getProblemByTeacher(this.state.loginRequest, teacher.id)
      ...
      <View style={styles.container}>     
        ...
        <View style={styles.footer}>
            <View style={styles.footerLeft}>
              ...
              >
                <Text style={styles.footerText}>Delete Problems</Text>
                <Icon
                  name='ios-trash'
                  type='ionicon'
                  color='#fff'
